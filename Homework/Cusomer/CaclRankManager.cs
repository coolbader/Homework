...
namespace Customer
{
    ...
    /// </summary>
    public class CaclRankManager : ICaclRankManager
    {
        /// <summary>
        ///  客户数据字典
        /// </summary>
        ...
        public void Execute()
        {
          List<CustomerVO> result=  _rankedCustomers.Select(a=>new CustomerVO {
           CustomerId= a.CustomerId, Score= a.Score, Rank= _rankedCustomers.GetIndex(a)
          }).ToList();
        }
    }
}